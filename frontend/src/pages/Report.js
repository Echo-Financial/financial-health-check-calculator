                ...
                <section className="cta-section section">
                    <div className="container">
                        ...
                        <div className="cta-content">
                            <h4>Ready to Transform Your Financial Future? Let's Do It Together.</h4>
                            <p>
                                Hey there! I'm from Echo Financial Advisors, and we do things differently.
                                Instead of pushing a one-size-fits-all solution, we start with your story and build from there.
                            </p>
                            <h5>Here's What Makes Us Special:</h5>
                            <ul>
                                <li>We combine cutting-edge AI technology with a personal touch</li>
                                <li>Your goals and dreams drive everything we do</li>
                                <li>You get strategies that actually make sense for <strong>YOUR</strong> life</li>
                            </ul>
                            ...
                            <p>
                                <strong>Don't Just Take My Word For It:</strong><br />
                                Join New Zealanders just like you, from across the country, who have started their journey with us.
                                They're already seeing their financial dreams take shape.
                            </p>
                            <h5>Want to Know What's Possible for You?</h5>
                            <ul>
                                <li>Your custom financial roadmap, powered by AI, with personalised human oversight</li>
                                <li>Real strategies that fit your life and goals</li>
                                <li>A genuine conversation about your future (no sales pitch, promise!)</li>
                            </ul>
